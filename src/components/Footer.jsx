          ...
          <div className="space-y-4 xl:space-y-5">
            ...
            <ul className="space-y-3 xl:space-y-3.5">
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:srianjaneyayouth09@gmail.com" className="text-xs sm:text-sm xl:text-[15px] text-[var(--text-muted)] hover:text-saffron-600 transition-colors">srianjaneyayouth09@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
